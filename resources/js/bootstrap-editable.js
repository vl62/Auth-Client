    ...
    $.extend(Text.prototype, {
        ...
        renderClear:  function() {
           if (this.options.clear) {
               this.$clear = $('<span class="editable-clear-x" title="Clear current value" ></span>');
...
(function ($) {
    ...
    //buttons
    $.fn.editableform.buttons = '<button type="submit" class="btn btn-primary editable-submit" title="Save current value" ><i class="icon-ok icon-white"></i></button>'+
                                '<button type="button" class="btn editable-cancel" title="Cancel editing"><i class="icon-remove"></i></button>';         
