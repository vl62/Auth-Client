...
$(document).ready(function () {
    ...
    $("#reset_precanned").click(function(e) {
        e.preventDefault();
    ...
    $("#buildQuery_precanned").click(function () {
        $("#query_result_precanned").empty();

        // console.log($("#collapsePrecanned").attr('data-collapsestatus'));
       // console.log($("#isPhenotype").attr('data-collapsestatus'));
       //  if($("#collapsePrecanned").attr('data-collapsestatus') && $("#isPhenotype").attr('data-collapsestatus')) {
       //      alert("You can query only on one type!");
       //      return;
       //  }
    ...
    //                        alert('test -> ' + data);
                    ...
                    $("#query_result_precanned").html(data);
                }
            });
        } else {
            alert("Select at least one precanend query.");
        }
    });

    $("#buildQuery_phenotype").click(function () {
        $("#query_result_phenotype").empty();
...
//        alert("queryString -> " + JSON.stringify($arr));
        ...
        $.ajax({url: baseurl + 'discover/query/' + $network_key,
            ...
            success: function (data) {
//                        alert('test -> ' + data);
                $('#waiting_phenotype').hide(500);
                $("#query_result_phenotype").html(data);
            }
        });
