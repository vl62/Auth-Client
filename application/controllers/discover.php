...
//		print_r($query_history);
	...
	function querybuilder() {
		$this->javascript = array('mustache.min.js', 'jquery.querybuilder.js');
		$this->css = array('jquery.querybuilder.css');
		$this->_render('query_builder/epad');
	}
...
//		$term = html_entity_decode($term);
		...
		if ( $term && $source && $sharing_policy ) {
			$term = urldecode($term);
//			echo "sending -> " . $federated_install_uri . "/discover/variants/$term/$source/$sharing_policy/$format";
			$variants = @file_get_contents($federated_install_uri . "/discover/variants/$term/$source/$sharing_policy/$format");
//			echo $variants;
