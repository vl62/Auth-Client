...
//	$('.online-offline').bind('change');
	$(function() {
		if (typeof prettyPrint === "function") {
			prettyPrint();
		}
		if (typeof jQuery.fn.toggleSwitch === "function") {
			$(".online-offline").toggleSwitch({
				highlight: true,
				width: 35,
				change: function(e) {
//					var $this = $(this);
...
//					var te = $("select").val()
//					var value = $("#toggledrop option:selected").val();
//					var text = $("#toggledrop option:selected").text();
//					alert("value changed -> " + value + " -> " + text);
				}
			});
		}
	});
