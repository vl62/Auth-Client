...
//			fields_and_conditions : {'gene':["equals", "fuzzy"], 'hgvs':['='], 'phenotype':['exactly', 'fuzzy']},
//			fields: {	'Genotype': {
//							'gene':["equals", "fuzzy"],
//							'coordinates':["equals", "not equal"],
//							'hgvs':["equals"]
//						},
//						'Phenotype': {
//							'phenotype_term':['exactly', 'fuzzy']
//						}
//					},
...
//							},
			...
			resource: ['variants'],
//			fields : {'url':'http://localhost/cafevariome/admin/get_fields'},
			logic: ['AND', 'OR', 'NOT'],
//			conditions : ['=', '<>', '<', '<=', '>', '>=', '*'],
//			conditions : {'url':'http://localhost/cafevariome/admin/get_conditions'},
//			conditions : ["equal", "not equal", "in", "not in", "begins with", "not begins with", "contains", "not contains", "ends with", "not ends with", "is empty", "is not empty", "is null", "is not null"],
			conditions : ["equals", "not equal", "in", "not in", "begins with", "not begins with", "contains", "not contains", "ends with", "not ends with"],
