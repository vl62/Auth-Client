...
class Ion_auth_mongodb_model extends CI_Model {
	...
	protected function _filter_data($collection, $data)
	{
		...
		$columns = $collection == 'users' ?
			...
			array('_id', 'ip_address', 'username', 'password', 'salt', 'email', 'activation_code', 'forgotten_password_code', 'forgotten_password_time', 'remember_code', 'created_on', 'last_login', 'active', 'first_name', 'last_name', 'company') :
