...
require_once('/Library/WebServer/Documents/cafevariome/application/third_party/Elastica/Bulk.php');
require_once('/Library/WebServer/Documents/cafevariome/application/third_party/Elastica/Bulk/Action.php');
require_once('/Library/WebServer/Documents/cafevariome/application/third_party/Elastica/Exception/ResponseException.php');
require_once('/Library/WebServer/Documents/cafevariome/application/third_party/Elastica/Exception/ClientException.php');
require_once('/Library/WebServer/Documents/cafevariome/application/third_party/Elastica/Exception/ConnectionException.php');
require_once('/Library/WebServer/Documents/cafevariome/application/third_party/Elastica/Exception/InvalidException.php');
require_once('/Library/WebServer/Documents/cafevariome/application/third_party/Elastica/Exception/RuntimeException.php');
...
class Client
{
    ...
    protected function _initConnections()
    {
        ...
        if (empty($this->_connections)) {
			error_log("test -> " . print_r($this->getConfig(), true));
