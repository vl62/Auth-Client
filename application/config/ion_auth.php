...
$config['tables']['sources_groups']  = 'sources_groups'; // Owen - added sources_groups
 ...
 */
$config['site_title']           = "Cafe Variome"; 	// Site Title, example.com
$config['admin_email']          = "admin@cafevariome.org"; 	// Admin Email, admin@example.com
$config['default_group']        = 'general';				// Default group, use name
...
/*
 ...
 | Default: auth/
 */
$config['email_templates'] = 'federated/auth/email/';
...
// Activate email template when user is created through admin interface
$config['email_activate_admin'] = 'activate_admin.tpl.php';
