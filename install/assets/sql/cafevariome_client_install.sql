...
CREATE TABLE `variants` (
  ...
  `g_chromosome` varchar(50) NOT NULL,
  `g_start` int(11) NOT NULL,
  `g_stop` int(11) NOT NULL,
  `g_build` varchar(50) NOT NULL,
  `a_location_ref` varchar(50) NOT NULL,
  `a_start` int(11) NOT NULL,
  `a_stop` int(11) NOT NULL,
  ...
  KEY `source` (`source`),
  KEY `gene` (`gene`),
  KEY `g_chromosome` (`g_chromosome`,`g_start`,`g_stop`),
  KEY `a_location_ref` (`a_location_ref`,`a_start`,`a_stop`),
