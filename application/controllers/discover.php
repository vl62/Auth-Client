...
//						$this->_render('pages/variantslovd');
	...
	function u_test() {
		error_log($this->config->item('auth_server') . "api/auth_general/get_basic_user_info");
		$users = authGetRequest('', $this->config->item('auth_server') . "/api/auth_general/get_basic_user_info");
		echo $users;
