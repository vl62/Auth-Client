...
//		$this->load->library('ion_auth');
	...
	function redirect()
	{
		$this->_render('oauth_auth_server/redirect');
	}
		...
		{		
			switch($doauth)
			{
				...
				case "Deny":
					...
					$this->data['error'] = 'access_denied';
					$this->data['error_description'] = 'The resource owner or authorization server denied the request.';
					if ($params['state'])
					{ 
...
//					redirect($redirect_uri, 'location');
					$this->_render('oauth_auth_server/not_authorized');
