...
$db['default']['username'] = "epadcentraladmin";
$db['default']['password'] = "tr33house";
$db['default']['database'] = "epad_central";
...
//$db['stats']['username'] = "epadcentraladmin"; // Add your mysql username
//$db['stats']['password'] = "tr33house"; // Add your mysql password
