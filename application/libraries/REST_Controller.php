...
class REST_Controller extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->request = new stdClass; // Added by Owen to avoid "Creating default object from empty value" error
		...
		$this->response = new stdClass; // Added by Owen to avoid "Creating default object from empty value" error
...
//		error_log("determine output");
	...
	// SECURITY FUNCTIONS ---------------------------------------------------------
	// Owen - modified as per https://github.com/philsturgeon/codeigniter-restserver/pull/42
	// Now allows auth override on a specific controller/method when the $config['rest_auth'] = FALSE
