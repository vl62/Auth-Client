...
|
*/
$config['rest_realm'] = 'Cafe Variome API';
...
*/
// $config['auth_override_class_method']['deals']['view'] = 'none';
$config['auth_override_class_method']['api']['private'] = 'basic';
//$config['auth_override_class_method']['api']['dasadd'] = 'basic';
...
|
*/
$config['rest_valid_logins'] = array('admin' => 'treehouse');
