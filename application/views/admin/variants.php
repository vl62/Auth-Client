			...
			<tbody>
				...
				<tr id="row<?php echo $source->source_id; ?>">
					...
					<td>
						...
						<?php if(false): ?>
						<a href="<?php echo base_url() . "variants/curate/" . $source->name;?>" rel="popover" data-content="Modify individual records for this source" data-original-title="Edit Records" ><i class="fa fa-pencil" style="color:black"></i></a>&nbsp;&nbsp;
						<?php endif; ?>

						<a href="#validateVariantsModal<?php echo $c; ?>" data-toggle="modal" data-backdrop="false" rel="popover" data-content="Validate the HGVS nomenclature of variants with Mutalyzer" data-original-title="Validate Variants" ><i class="icon-check"></i></a>&nbsp;&nbsp;

						<a href="#linkModal<?php echo $c; ?>" data-toggle="modal" data-backdrop="false" rel="popover" data-content="Changes the link address for ALL records in this source (clicking brings up selection window). If you want to change the link for individual records, click on the curate/edit action." data-original-title="Set Link Address"><i class="fa fa-link" style="color:black"></i></a>&nbsp;&nbsp;
						
						<?php if(false): ?>
						<a href="#sharingPolicyModal<?php echo $c; ?>" data-toggle="modal" data-backdrop="false" rel="popover" data-content="Changes the sharing policy for ALL records in this source (clicking brings up selection window). If you want to change the sharing policy for individual records, click on the curate/edit action." data-original-title="Set Sharing Policy"><i class="icon-share"></i></a>&nbsp;&nbsp;
						<?php endif; ?>

						<a href="<?php echo base_url() . "variants/delete/" . $source->name;?>" rel="popover" data-content="Delete ALL variants for this source" data-original-title="Remove Variants"><i class="icon-trash"></i></a>
