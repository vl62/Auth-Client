  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml">
      <head>
        ...
        <title>DASIgniter: Features for <xsl:value-of select="/DASGFF/GFF/@href"/></title></head>
      <body>
        <div id="header"><h4>DASIgniter: Features for <xsl:value-of select="/DASGFF/GFF/@href"/></h4></div>
        <div id="mainbody">
          <p>Format:
