...
CREATE DATABASE IF NOT EXISTS `cafevariome_client_install` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `cafevariome_client_install`;
...
INSERT INTO `genes` (`gene_symbol`) VALUES
('A1BG'),
('A1BG-AS1'),
('A1CF'),
('A2M'),
...
(32, 'auth_server', 'http://localhost/cafevariome_server/', 'Central Cafe Variome Auth server url (WARNING: do not change)', 'xss_clean'),
