...
class Xml_writer extends XMLWriter
{
    ...
    public function setRootAttributes ($rootAttributes = array())
    {
...
//		$this->writeAttribute("xmlns", "http://varioml.org/xml/1.0");
		if ( $this->_rootAttributes ) {
			$this->_addAttributes($this->_rootAttributes);
		}
//		$this->startElementNS('cafevariome', 'bar', 'http://example.com/foo'); 
    }
    ...
    public function addNodeSimple ($name, $attributes = array(), $cdata = false)
    {
        /**
         * Set a CDATA element.
         */
