    ...
    <div class="row-fluid" id="genotype_phenotype">
        <div class="span12 pagination-centered">
            ...
            <ul class="nav nav-tabs">
                <li class="active" style="width: 50%;"><a href="#tab-phenotype" data-toggle="tab">Phenotype Query</a></li>
                <li style="width: 50%;"><a href="#tab-precanned" data-toggle="tab">Precanned Query</a></li>
            </ul>
