	...
	<div class="row">  
		<div class="span6">  
			<ul class="breadcrumb">
				...
				<?php endif; ?>
				<li>
					<a href="<?php echo base_url() . "variants/curate/$source";?>">Curate</a> <span class="divider">></span>
				</li>
		...
		<div class="span12">
			...
			<div class="well pagination-centered">
				...
				<div class="row var" id="var" name="var">
					...
					<div class="span2"><?php echo nbs(4); ?> &nbsp;&nbsp;&nbsp;&nbsp;<button onclick="mutalyzerValidate(); return false;" class="btn btn-small" rel="popover" data-content="Click to validate the syntax of this variant using the Mutalyzer webservice." data-original-title="Validate Variant"><i class="icon-check"></i> Validate</button></div>
...
<!--					<div class="span3 offset9"><button class="btn btn-small"><i class="icon-plus"></i> Add Additional</button></div>-->
				...
				<div class="row">
					...
					echo form_dropdown('sharing_policy', $options, $variant_data['sharing_policy']);
					?>
				</div>
...
<!--					<div class="span2 offset8"><button class="btn btn-small" id="additionalvariant" name="additionalvariant"><i class="icon-plus"></i> Add Additional</button></div>-->
					<div class="span2 offset10"><button class="btn btn-small" id="clearvariant" name="clearvariant" ><i class="icon-remove-sign"></i> Clear</button></div>
				</div>
			</div>
...
<div class=\"row\"><div class=\"span6 offset3\"><input name=\"oi_$key\" id=\"ont_item_$key\" type=\"text\" class=\"bp_form_complete-$key-name\" style=\"width:29em\"/> <span class=\"add-on\"><a href=\"#\" rel=\"popover\" data-content=\"Type the first three characters of a $val term to initiate the autocomplete. Once a term has been selected from the lookup click the <i>Add to description</i> button\"  data-original-title=\"Lookup terms from the latest version of the ontology\"><i class=\"icon-question-sign\"></i></a></span> <input type=\"hidden\" id=\"version_$key\" value=\"$key\"></div></div>
...
//    echo form_dropdown('ont_list', array(), '', 'size="10" name="ont_list" id="ont_list"');
    echo form_dropdown('ont_list', $existing_phenotypes, '', 'size="5" name="ont_list" id="ont_list"');
}
?>
			...
			<div class="well pagination-centered">
				...
				<div class="row">
					<div class="span2 offset10"><button class="btn btn-small" id="clearpatient" name="clearpatient"><i class="icon-remove-sign"></i> Clear</button></div>
				</div>
			</div>
			<div class="well pagination-centered">
				<div class="row">
				...
				<div class="row">
					<div class="span2 offset10"><button class="btn btn-small" id="clearadditional" name="clearadditional"><i class="icon-remove-sign"></i> Clear</button></div>
				</div>
			</div>
			<div class="well pagination-centered">
				<div class="row">
					<button type="button" onclick="submitForm()" class="btn btn-primary"><i class="icon-file icon-white"></i>  Save Variant</button><?php echo nbs(6); ?><button type="reset" class="btn"><i class="icon-remove-sign"></i> Clear All</button><?php echo nbs(6); ?><a href="<?php echo base_url() . "variants/curate/$source";?>" class="btn" ><i class="icon-step-backward"></i> Go back</a>
				</div>
			</div>
			<?php if ( isset($result) ) { echo "<p>Source was successfully added</p>"; } ?>
		</div>
	</div>
</div>
<?php echo form_close(); ?>
